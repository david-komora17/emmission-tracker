                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-md w-full space-y-4 relative">
                        <button 
                            ...
                            disabled={pollingStatus === 'polling' || offsetLoading}
                        >
                            <X className="w-4 h-4" />
                        </button>
                        ...
                        {!paymentSent ? (
                            ...
                            <div className="space-y-3">
                                ...
                                <button
                                    onClick={() => setShowOffsetConfirm(false)}
                                    className="w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-xs font-medium transition-colors"
                                    disabled={pollingStatus === 'polling'}
                                >
                                    {pollingStatus === 'polling' ? 'Processing Transaction...' : 'Close Window'}
                                </button>
                            </div>
                        )}
                    </div>
